defmodule Money.SQL.Repo.Migrations.AddPostgresMoneyAvgFunction do
  use Ecto.Migration
  ...
  def down do
    execute("DROP AGGREGATE IF EXISTS avg(money_with_currency);")
    execute("DROP FUNCTION IF EXISTS money_avg_final_function(agg_state money_avg_state);")
    ...
    execute("DROP TYPE IF EXISTS money_avg_state;")
  end
end